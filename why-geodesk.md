...
The crux of the problem is this: That shiny OpenStreetMap .pbf file you just downloaded is nothing but an inscrutable hunk of bits until you load it into a database, where you can dissect it with spatial queries. But importing into a traditional SQL-based DBMS turns that already hefty OSM file into a monstrous hulking beast. *You're gonna need a bigger drive!*
